...
![](C:/Advance Data Analysis/unilogo.png)
...
environment <- readRDS("C:/Advance Data Analysis/MOD3_Multivariate_MD_DIDER_218203108/environment.rds")
macroinvertebrates <- readRDS("C:/Advance Data Analysis/MOD3_Multivariate_MD_DIDER_218203108/macroinvertebrates.rds")
```
...
species_ex <- read.csv("C:/Advance Data Analysis/MOD3_Multivariate_MD_DIDER_218203108/species_final.csv")
```
...
library(ade4)
trans.var
sp <- read.csv("C:/Advance Data Analysis/MOD3_Multivariate_MD_DIDER_218203108/Species_Final_FD.csv")
trait_macro <- read.csv("C:/Advance Data Analysis/MOD3_Multivariate_MD_DIDER_218203108/trait_Final_FD.csv")
```
